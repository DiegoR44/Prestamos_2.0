...
namespace ProyectoPrestamo.Formularios
{
    public partial class frmRegistrarCobro : Form
    {
        ...
        {
            PageCobro.SelectedIndex = 1;

        }

        private void iconButton2_Click(object sender, EventArgs e)
        {
            PageCobro.SelectedIndex = 0;
        ...
        private void btnbuscar_Click_1(object sender, EventArgs e)
        {
            ...
            if (obj.IdPrestamo != 0)
            {
                if (obj.Estado == "EN CURSO")
                {
                    ...
                    bunifuTextBox1.Text = obj.MontoPrestamo;
        ...
        private void rbdocumentocliente_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void rbnrooperacion_CheckedChanged_1(object sender, EventArgs e)
        {
            txtnrooperacion.Enabled = true;
            txtnrooperacion.Text = "";
