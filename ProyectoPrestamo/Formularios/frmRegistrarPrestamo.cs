...
namespace ProyectoPrestamo.Formularios
{
    public partial class frmRegistrarPrestamo : Form
    {
        ...
        private void txttotalinteres_TextChanged(object sender, EventArgs e)
        {

        }

        private void btnbuscarinmuebles_Click_1(object sender, EventArgs e)
        {
        ...
        {
            PagePrestamo.PageIndex = 0;
        }

        private void iconButton2_Click(object sender, EventArgs e)
        {
            PagePrestamo.PageIndex = 1;
        }
    }
}
